...
//content lenght!
String part2 = "Content-Length: 50\r\n\r\n";
...
String ii = String(ic);  
  ...
  client.println("AT+CIPSEND=4,178");
  delay(100);
  //tu ponizej wlasciwy POST docelowo
  client.print(part1 + part2 + part3 + sensors.getTempCByIndex(0) + part4 + sensors.getTempCByIndex(1) + part5 + AVG_DUST);
