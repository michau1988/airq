...
String IP="";
char temp1='0';
String name="<p>Temapratures</p>";   //22
String dat="<p>from Arduino</p>";     //21
...
void wifi_init()
{
      ...
      if(!No_IP)
      {
       ...
       connect_wifi("AT+CWJAP=\"Asd\",\"1234567888\"",8000);         //provide your WiFi username and password here
...
void Send()
{
      webpage = "<h1>Welcome AirQ members ;)</h1><body bgcolor=f0f0f0>";
      sendwebdata(webpage);
      webpage=name;
      webpage+=dat;
      sendwebdata(webpage);
