    ...
    while(client.available()>0)
    {
      ...
      if(client.find("STAIP,\""))
      {
        ...
        while(client.available()>0)
        {
          ...
          IP+=ch;
          //if(IP.length()==13)
          //Serial.println("dugosc znaku za dluga");
          //break;
        }
      }
      if(ch=='+')
...
String server = "192.168.0.15"; // www.example.com

String uri = "insert4.php";
  
//post data 
 webpage = "POST /insert4.php HTTP/1.0\r\n"; 
 
 webpage+="Host: 192.168.0.15\r\n";
 webpage+="Accept: */*\r\n";
 webpage+="Content-Length: ";
 webpage+="14"
 webpage+="\r\n";
 webpage+="Content-Type: application/x-www-form-urlencoded\r\n";
 webpage+="\r\n";
 webpage+="temperature=41";
