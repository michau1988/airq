...
SoftwareSerial client(2,3); //RX, TX PINS 2 and 3
...
void get_ip()
{
  ...
  {
    Serial.print("While\r\n");
    client.println("AT+CIPSTA=\"192.168.0.120\"");
    delay(5000);
        ...
        if(OK=true)
          {
            ...
            //get_ip();
            connect_wifi("AT+CIPSTA=\"192.168.0.120\"",2000);
...
//  webpage = "<html><head></head><body style=\"background-color:green;\">";
//    sendwebdata(webpage);


  webpage = "<html><head></head><body style=\"background-color:grey;\">";
      
  webpage += "<h1>Welcome to AirQ</h1><table style=\"width:50%\">";
